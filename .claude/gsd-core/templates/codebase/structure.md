...
- Usage: Reference from command with `@D:/Molds/mp-card-creator/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Molds/mp-card-creator/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Molds/mp-card-creator/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
