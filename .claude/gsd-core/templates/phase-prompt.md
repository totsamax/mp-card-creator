...
<!-- For checkpoint task examples and patterns, see @D:/Molds/mp-card-creator/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/Molds/mp-card-creator/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Molds/mp-card-creator/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Molds/mp-card-creator/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
