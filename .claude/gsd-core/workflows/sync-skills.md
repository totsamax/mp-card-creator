...
INSTALL_JS_GLOBAL="D:/Molds/mp-card-creator/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Molds/mp-card-creator/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
