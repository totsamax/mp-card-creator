...
<required_reading>
@D:/Molds/mp-card-creator/.claude/gsd-core/references/ai-frameworks.md
@D:/Molds/mp-card-creator/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Molds/mp-card-creator/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-eval-planner.md for instructions.
