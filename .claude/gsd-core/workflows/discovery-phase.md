...
See D:/Molds/mp-card-creator/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/Molds/mp-card-creator/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/Molds/mp-card-creator/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/Molds/mp-card-creator/.claude/gsd-core/templates/discovery.md
...
Use D:/Molds/mp-card-creator/.claude/gsd-core/templates/discovery.md.
