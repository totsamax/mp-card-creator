...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Molds/mp-card-creator/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Molds/mp-card-creator/.claude/agents/gsd-ui-checker.md for instructions.
