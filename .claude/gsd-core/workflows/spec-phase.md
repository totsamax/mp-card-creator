...
ones). Reference: @D:/Molds/mp-card-creator/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/Molds/mp-card-creator/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/Molds/mp-card-creator/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/Molds/mp-card-creator/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/Molds/mp-card-creator/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/Molds/mp-card-creator/.claude/gsd-core/templates/spec.md.
