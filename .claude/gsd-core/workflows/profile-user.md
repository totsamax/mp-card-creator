...
Key references:
- @D:/Molds/mp-card-creator/.claude/gsd-core/references/ui-brand.md (display patterns)
- @D:/Molds/mp-card-creator/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Molds/mp-card-creator/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md" "D:/Molds/mp-card-creator/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Molds/mp-card-creator/.claude/gsd-core/references/user-profiling.md`
...
Reference: @D:/Molds/mp-card-creator/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/Molds/mp-card-creator/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Molds/mp-card-creator/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Molds/mp-card-creator/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/Molds/mp-card-creator/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Molds/mp-card-creator/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Molds/mp-card-creator/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        D:/Molds/mp-card-creator/.claude/CLAUDE.md
```
