...
```
Agent(
  prompt="Read D:/Molds/mp-card-creator/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Molds/mp-card-creator/.claude/gsd-core/templates/SECURITY.md`
