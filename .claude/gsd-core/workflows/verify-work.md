...
<template>
@D:/Molds/mp-card-creator/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/Molds/mp-card-creator/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/Molds/mp-card-creator/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/Molds/mp-card-creator/.claude/gsd-core/workflows/diagnose-issues.md
