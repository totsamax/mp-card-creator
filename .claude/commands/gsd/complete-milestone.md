...
- @D:/Molds/mp-card-creator/.claude/gsd-core/workflows/complete-milestone.md (main workflow)
- @D:/Molds/mp-card-creator/.claude/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
