...
Reference full template: `D:/Molds/mp-card-creator/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Molds/mp-card-creator/.claude/gsd-core/templates/state.md`.
