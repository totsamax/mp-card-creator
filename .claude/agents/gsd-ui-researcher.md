...
Use template from `D:/Molds/mp-card-creator/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/Molds/mp-card-creator/.claude/gsd-core/templates/UI-SPEC.md`
