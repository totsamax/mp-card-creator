...
<reference>
@D:/Molds/mp-card-creator/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Molds/mp-card-creator/.claude/gsd-core/references/user-profiling.md` to load:
