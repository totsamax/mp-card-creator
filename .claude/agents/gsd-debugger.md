...
<required_reading>
@D:/Molds/mp-card-creator/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/Molds/mp-card-creator/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Molds/mp-card-creator/.claude
                  → checks D:/Molds/mp-card-creator/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Molds/mp-card-creator/.claude/gsd-core
                  → writes to D:/Molds/mp-card-creator/.claude/gsd-core/hooks/
...
@D:/Molds/mp-card-creator/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/Molds/mp-card-creator/.claude/gsd-core/references/common-bug-patterns.md
